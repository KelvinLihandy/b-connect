...
const Preview = ({ serviceData, onClose }) => {
  ...
  return (
    <motion.div
      className="fixed inset-0 bg-black bg-opacity-75 z-50 p-0 sm:p-4"
    ...
    >
      <motion.div
        ...
        exit="exit"
      >
        <div className="bg-gray-100 p-3 sm:p-4 border-b flex justify-between items-center">
          <h2 className="text-sm sm:text-xl font-bold text-center text-red-500 font-Archivo flex-grow">
            ***This is a Preview of Your Add Page Progress***
          </h2>
        ...
        <div className="h-[calc(100%-57px)] sm:h-[calc(100%-64px)] overflow-auto">
          <div className="container mx-auto px-4 py-6 sm:py-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
              <div className="lg:col-span-8">
                ...
                <div className="flex flex-wrap items-center mt-2 mb-6 text-base sm:text-lg font-bold">
                  ...
                  <div className="flex text-yellow-400 w-full sm:w-auto mt-1 sm:mt-0">
                ...
                <div
                  className="relative mb-6 rounded-lg overflow-hidden bg-gray-100 h-64 sm:h-80 md:h-96 lg:h-120 xl:h-150 shadow-lg"
                ...
                >
                  ...
                  {images && images.length > 1 && (
                    <>
                      <motion.button
                        className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-1 sm:p-2 shadow-md opacity-80 hover:opacity-100 hover:scale-110 transition-all z-10"
                        onClick={prevImage}
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                      >
                      ...
                      <motion.button
                        className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white rounded-full p-1 sm:p-2 shadow-md opacity-80 hover:opacity-100 hover:scale-110 transition-all z-10"
                        onClick={nextImage}
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                      >
                ...
                <div className="border-t my-6 pt-4">
                  <h2 className="text-xl font-bold mb-2">Workflow Overview</h2>
                  <div className="flex flex-col gap-1">
                    {serviceData?.workFlows?.map((flow, index) => (
                      <h3 key={index} className="font-bold text-base sm:text-lg">
                        {index + 1}. {flow}
                      </h3>
                    ))}
                    {(!serviceData?.workFlows || serviceData?.workFlows.length === 0) && (
                      <p className="text-gray-500 text-sm sm:text-base">No workflow steps provided</p>
                    )}
                  </div>
                </div>
              </div>
              ...
              <div className="lg:col-span-4">
                <div className="sticky top-4">
                  <div className="border rounded-lg shadow-sm overflow-hidden">
                    <div className="flex">
                      <motion.button
                        className={`flex-1 py-3 text-center font-medium transition-colors duration-300 text-sm sm:text-base ${activePackage === 0
                      ...
                      <motion.button
                        className={`flex-1 py-3 text-center font-medium transition-colors duration-300 text-sm sm:text-base ${activePackage === 1
                          ? "border-b-2 border-blue-600 text-blue-600"
                          : "text-gray-600 hover:text-blue-500"
                          }`}
                    ...
                    <div className="p-4 sm:p-6">
                      <AnimatePresence mode="wait">
                        ...
                        >
                          {activePackage === 0 ? (
                            <div>
                              <div className="flex flex-row justify-between">
                                <h3 className="text-2xl sm:text-3xl font-bold font-inter">Rp. {formattedPrice(packages?.basic?.harga || 0)}</h3>
                              </div>
                              <div className="text-gray-600 text-sm mt-3 border-t pt-3">
                            ...
                            <div>
                              <div className="flex flex-row justify-between">
                                <h3 className="text-2xl sm:text-3xl font-bold font-inter">Rp. {formattedPrice(packages?.advance?.harga || 0)}</h3>
                              </div>
                              <div className="text-gray-600 text-sm mt-3 border-t pt-3">
                                <div className="flex items-start gap-2 mt-2">
                                  <Check className="text-green-500 mt-0.5 flex-shrink-0" size={16} />
                          ...
                          <motion.button
                            className="w-full mt-6 bg-blue-700 hover:bg-blue-800 text-white py-2 sm:py-3 px-4 rounded-md font-medium flex items-center justify-center text-sm sm:text-base"
                          ...
                          <motion.button
                            className="w-full mt-3 border border-gray-300 text-gray-700 hover:bg-gray-50 py-2 sm:py-3 px-4 rounded-md font-medium text-sm sm:text-base"
                            whileHover={{ scale: 1.02 }}
                            whileTap={{ scale: 0.98 }}
                          >
                            Contact B-Partner
