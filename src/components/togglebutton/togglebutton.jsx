  ...
  return (
    <div className="flex justify-center items-center p-4">
      <div
        ref={containerRef}
        onClick={toggleMode}
        className={`relative cursor-pointer px-3 py-3  flex items-center ${isSellerMode}`}
        style={{
          minWidth: "170px",
        }}
      >
        ...
        {/* Text content with proper transition */}
        <div className="flex-grow relative h-6 overflow-hidden">
          <div
            className={`absolute w-full transition-transform duration-300 ease-in-out ${
              isSellerMode ? "translate-y-0" : "-translate-y-full"
            }`}
          >
          ...
          <div
            className={`absolute w-full transition-transform duration-300 ease-in-out ${
              isSellerMode ? "translate-y-full" : "translate-y-0"
            }`}
          >
