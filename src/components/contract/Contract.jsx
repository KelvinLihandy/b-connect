...
const Contract = ({ isOpen, onClose, gigId, packages }) => {
  ...
  const [basePrice, setBasePrice] = useState(0); //price pass ke midtrans
    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <motion.div
          ...
          role="dialog"
          aria-modal="true"
          onClick={finishPay ? null : onClose}
          initial="hidden"
          animate="visible"
          exit="exit"
        >
                ...
                <div className="bg-white">
                  <div>
                    ...
                    <div className="p-6 flex flex-col h-200 gap-10">
                      ...
                      {step === 3 && !finishPay && (
                        <>
                          <button onClick={() => setFinishPay(true)}>finish pay click</button>
                        </>
                      )}
                      {step === 3 && finishPay && (
                        <>
                          <div className="flex flex-col items-center font-Archivo justify-between h-full py-20">
                            <div className="flex flex-col items-center gap-4">
                              ...
                              <p className="font-[#636363]">
                                Selamat! Pesanan Anda telah berhasil diproses dan akan diteruskan ke
                                B-Partner kami🎊
                              </p>
                            </div>
                            <motion.img
