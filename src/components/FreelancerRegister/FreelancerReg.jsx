          ...
          >
            ...
            <div className="fixed inset-0 z-10 w-screen h-screen overflow-y-auto">
              <div className="flex min-h-full items-center justify-center p-2 sm:p-4 text-center">
                <motion.div
                  className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all w-full sm:max-w-lg md:max-w-2xl lg:max-w-3xl max-h-[90vh] flex flex-col"
                ...
                >
                    ...
                    <div className="py-3 px-4 sm:py-4 sm:px-6 text-center sm:text-left bg-[linear-gradient(116deg,_#2E5077_2.68%,_#4DA1A9_102.1%)] flex flex-row justify-between w-full items-center select-none">
                      ...
                      {step < 3 &&
                        <motion.button
                          ...
                          className="w-8 h-8 sm:w-10 sm:h-10 cursor-pointer text-white font-bold text-xl sm:text-2xl"
                          onClick={onClose}
                        >
                          ✕
                        </motion.button>
                  ...
                  {step === 0 ? (
                    ...
                    <div className="p-4 sm:p-6 flex flex-col min-h-[480px] max-h-[calc(90vh-68px)] overflow-y-auto">
                      <div className="w-full mb-6 px-4 sm:px-8">
                        <div className="flex justify-between items-center relative">
                          <div className="absolute left-0 right-0 h-1 top-1/2 -translate-y-1/2 bg-gray-200 z-0">
                            <div
                          ...
                          <div className="flex flex-col items-center z-10 w-1/3 text-center">
                            <div
                              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center mb-2 ${step >= 1
                          ...
                          <div className="flex flex-col items-center z-10 w-1/3 text-center">
                            <div
                              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center mb-2 ${step >= 2
                                ? "bg-blue-500 text-white"
                                : "bg-gray-200 text-gray-500"
                                }`}
                            >
                          ...
                          <div className="flex flex-col items-center z-10 w-1/3 text-center">
                            <div
                              className={`w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center mb-2 ${step >= 3
                                ? "bg-blue-500 text-white"
                                : "bg-gray-200 text-gray-500"
                                }`}
                            >
                          ...
                          <div className="bg-white rounded-lg p-4 sm:p-6 border border-gray-200">
                            ...
                            <div className="flex-1 mb-6">
                              ...
                              <div className="relative" ref={dropdownRef}>
                                <input
                                  type="text"
                                  className={`w-full px-3 py-2 border text-sm sm:text-base ${formErrors.category ? "border-red-500" : "border-gray-400"
                              ...
                              <div className="flex flex-wrap gap-2 mt-2">
                                {selectedCategories.map((cat, index) => (
                                  <span
                                    key={index}
                                    className="inline-flex items-center px-3 py-1 bg-gray-100 rounded-full text-xs sm:text-sm"
                                  >
                                    {cat}
                                    <button
                            ...
                            <div className="mb-4">
                              ...
                              <textarea
                                ...
                                className={`w-full p-2 border rounded h-32 text-sm sm:text-base
                            ...
                            <div>
                              ...
                              <div className={`px-2 sm:px-4 py-4 border ${formErrors.studentIdFile ? "border-red-500" : "border-gray-300"} rounded-md`}>
                                <div className="mb-4">
                                  {!selectedStudentFile ? (
                                    <div
                                      className="border-2 border-dashed border-gray-300 rounded-md p-4 sm:p-8 text-center cursor-pointer hover:bg-gray-50 transition-colors"
                      ...
                      {step === 2 && (
                        <div className="space-y-4">
                          ...
                          <div className="bg-gray-50 p-4 rounded border border-gray-200 text-sm sm:text-base">
                        ...
                        <div className="space-y-4 text-center">
                          <div className="flex justify-center mb-6">
                            <div className="w-20 h-20 sm:w-24 sm:h-24 bg-green-100 rounded-full flex items-center justify-center">
                              <span className="text-green-500 text-3xl sm:text-4xl">✓</span>
                            </div>
                          </div>
                          <h4 className="text-lg sm:text-xl font-bold">Registration Selesai!</h4>
                        ...
                        {step > 0 && step < 3 && (
                          <>
                            ...
                            <button
                              ...
                              disabled={isSaving || (step === 1 && !isFormValid())}
                              className={`px-4 py-2 rounded text-sm sm:text-base ${step === 1 && !isFormValid()
