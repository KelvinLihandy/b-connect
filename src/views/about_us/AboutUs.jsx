...
const AboutUs = () => {
  ...
  return (
    ...
    >
      ...
      <div className="block font-Archivo text-[#171A1F] mx-20 my-40">
        ...
        <div className='flex relative flex-col md:flex-row gap-10 py-10 h-full'>
          ...
          <div className="relative w-full flex flex-col gap-2 top-20 p-5">
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedItems.includes(1) ? 'max-h-[500px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'
                }`}
            >
              <p className='text-[30px]'>
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedItems.includes(2) ? 'max-h-[500px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'
                }`}
            >
              <p className='text-[30px]'>
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedItems.includes(3) ? 'max-h-[500px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'
                }`}
            >
              <p className='text-[30px]'>
                B-Connect adalah platform yang menghubungkan mahasiswa dan alumni Binus University dengan klien atau project owner yang membutuhkan jasa freelance. Tujuannya adalah menciptakan ekosistem kerja profesional di lingkungan Binus, sekaligus membuka peluang kolaborasi dan pengalaman kerja nyata.
            ...
            <div
              className={`overflow-hidden transition-all duration-500 ease-in-out ${expandedItems.includes(4) ? 'max-h-[500px] opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-2'
                }`}
            >
              <p className='text-[30px]'>
                B-Connect adalah platform yang menghubungkan mahasiswa dan alumni Binus University dengan klien atau project owner yang membutuhkan jasa freelance. Tujuannya adalah menciptakan ekosistem kerja profesional di lingkungan Binus, sekaligus membuka peluang kolaborasi dan pengalaman kerja nyata.
      ...
      <Footer refScrollUp={aboutScrollUp}/>
    </div>
  );
};
