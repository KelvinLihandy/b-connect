      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="space-y-6">
            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">1. Informasi yang Kami Kumpulkan</h2>
            ...
            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">2. Cara Kami Menggunakan Informasi Anda</h2>
              <div className="space-y-3 text-base text-gray-700">
            ...
            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">3. Berbagi Informasi</h2>
              <div className="space-y-3 text-base text-gray-700">
            ...
            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">4. Keamanan Data</h2>
              <p className="text-base text-gray-700">Kami menerapkan langkah-langkah keamanan yang tepat untuk melindungi informasi pribadi Anda dari akses, perubahan, pengungkapan, atau penghancuran yang tidak sah. Ini termasuk enkripsi data, autentikasi berlapis, dan monitoring keamanan. Namun, tidak ada metode transmisi melalui internet yang 100% aman, dan kami tidak dapat menjamin keamanan absolut.</p>
            </section>

            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">5. Hak Anda</h2>
              <div className="space-y-3 text-base text-gray-700">
            ...
            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">6. Cookie dan Pelacakan</h2>
              <p className="text-base text-gray-700">Kami menggunakan cookie dan teknologi pelacakan serupa untuk meningkatkan pengalaman Anda di B-Connect, termasuk mengingat preferensi pencarian, menyimpan sesi login, dan menganalisis penggunaan platform. Anda dapat mengontrol pengaturan cookie melalui preferensi browser Anda.</p>
            </section>

            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">7. Privasi Anak</h2>
              <p className="text-base text-gray-700">B-Connect tidak ditujukan untuk anak-anak di bawah usia 17 tahun. Kami tidak secara sengaja mengumpulkan informasi pribadi dari anak-anak di bawah 17 tahun. Jika Anda mengetahui bahwa anak di bawah umur telah memberikan informasi pribadi kepada kami, silakan hubungi kami untuk menghapus informasi tersebut.</p>
            </section>

            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">8. Pengguna Internasional</h2>
              <p className="text-base text-gray-700">Jika Anda mengakses layanan kami dari luar Indonesia, harap dicatat bahwa informasi Anda dapat ditransfer dan diproses di Indonesia, tempat server kami berada.</p>
            </section>

            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">9. Perubahan Kebijakan</h2>
              <p className="text-base text-gray-700">Kami dapat memperbarui Kebijakan Privasi ini dari waktu ke waktu. Kami akan memberi tahu Anda tentang perubahan apa pun dengan memposting Kebijakan Privasi baru di halaman ini dan memperbarui tanggal "Terakhir Diperbarui".</p>
            </section>

            <section>
              <h2 className="font-semibold text-xl mb-4 text-gray-900">10. Hubungi Kami</h2>
              <div className="space-y-3 text-base text-gray-700">
